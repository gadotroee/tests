...
class Tests_trcc_api_service_tradmin(unittest.TestCase):
    ...
    def test_40_get_models_roee_status(self):
        # GET http://trcc-api-service.tradmin/models/roee/status (endp 40)
    ...
    def test_41_get_models_roee_suites_all_runs_state(self):
        # GET http://trcc-api-service.tradmin/models/roee/suites/all/runs/state (endp 41)
        trcc_api_service_tradmin = get_http_target('TARGET_TRCC_API_SERVICE_TRADMIN', authenticate)
